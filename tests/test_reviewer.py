...
class TestReviewAlgorithm(unittest.TestCase):
    ...
    def test_early_review_2(self):
        ...
        self.aft_reviewer_info = deque()
        self.aft_reviewer_info_total_len = 3
        self.aft_reviewer_info_len = 0
        self.aft_today_drill_info = set()
        targets = [
            [8, 1.3, 8],
            [11, 8 / 6, 11],
            [2, 1.3, 2]
    ...
    def test_early_review_3(self):
        ...
        self.aft_reviewer_info = deque()
        self.aft_reviewer_info_total_len = 2
        self.aft_reviewer_info_len = 0
        self.aft_today_drill_info = {'1', '2'}
        targets = [
            [8, 1.3, 1],
            [11, 1.3, 1],
        ]
    ...
    def test_late_review_1(self):
        ...
        self.aft_reviewer_info = deque()
        self.aft_reviewer_info_total_len = 1
        self.aft_reviewer_info_len = 0
        self.aft_today_drill_info = set()
        targets = [
            [27, 1.8, 27],
